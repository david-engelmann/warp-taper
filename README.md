...
![warp-taper demo — driving Warp via CGEventPost, recording its window buffer via ScreenCaptureKit](docs/sample-tape/master.gif)

> The recording above is `docs/sample-tape/master.gif` — produced by
